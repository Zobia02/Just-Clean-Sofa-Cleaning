...
public class velvet_pricing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_velvet_pricing);
    ...
    public void Velvet_checkout(View view) {
        ...
        Intent intent3=new Intent(this,velvet_bill.class);
        intent3.putExtra("NUM",numOfSeats);
